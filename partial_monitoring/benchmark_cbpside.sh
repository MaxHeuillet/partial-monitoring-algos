...
python3 ./partial_monitoring/benchmark_cbpside.py --horizon ${HORIZON} --n_folds ${NFOLDS} --game ${GAME} --alg 'CBPside005' --task ${TASK} --context_type ${CONTEXT_TYPE} > stdout_$SLURM_JOB_ID 2>stderr_$SLURM_JOB_ID
