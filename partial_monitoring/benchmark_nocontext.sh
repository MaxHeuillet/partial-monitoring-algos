...
python3 ./partial_monitoring/benchmark_nocontext.py --horizon ${HORIZON} --n_folds ${NFOLDS} --game ${GAME} --alg ${ALG} --task ${TASK} > stdout_$SLURM_JOB_ID 2>stderr_$SLURM_JOB_ID
